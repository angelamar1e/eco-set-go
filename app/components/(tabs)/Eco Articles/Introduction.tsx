...
const Introduction = () => {
  ...
  return (
    <StyledLayout className="flex-1 p-4">
      <BackButton/>
      <StyledText className="text-xl text-center mb-2" style={{ fontFamily: 'Poppins-SemiBold'}}>
      ...
      <ScrollView>
        ...
        <StyledLayout>
          <StyledText category="p1" className=" font-bold m-2">
        ...
        <StyledLayout>
          ...
          <StyledText category="h5" className="ml-2 mr-2">🍃</StyledText>
            ...
            {'\n'}<StyledText category='p2' className='font-bold'>Transportation: </StyledText>This sector accounts for around 17.9% of global GHG emissions. This includes emissions from all forms of transport–including cars, airplanes, ships, and trains. For individuals, this involves daily commutes and travel.
            {'\n'}<StyledText category='p2' className='font-bold'>Energy Production: </StyledText> The generation of electricity and heat contributes around 39.3% of the global emissions, while its consumption through heating, cooling, and electricity usage within homes and buildings contribute around 9.9% to global GHG emissions. 
            ...
            {'\n'}<StyledText category='p2' className='font-bold'>Agriculture: </StyledText>This sector is responsible for about 12% of global GHG emissions. It includes emissions from livestock production, rice cultivation, and use of nitrogenous fertilizers which are the main producers of methane and nitrous oxide.
          </StyledText>
          </StyledLayout>
        </StyledLayout>
