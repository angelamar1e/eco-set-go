    ...
    <StyledLayout className="flex-1 p-4">
      ...
      <ScrollView>
        <StyledCard className='items-center m-2 rounded-lg' style={{ backgroundColor: myTheme['color-success-700']}}>
          <StyledText  category='h6' className='font-bold text-white text-center'>about 2 tons of CO2e per year</StyledText>
          <StyledText category='p2' className='text-center text-white mt-2'>It is recommended that each Filipino aim for a carbon footprint of this amount to align with both global and national climate targets.</StyledText>
        </StyledCard>
        <StyledLayout>
